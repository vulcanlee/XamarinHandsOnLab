...
using XamarinHandsOnLabService.Migrations;
...
namespace XamarinHandsOnLabService
{
    ...
    public class XamarinHandsOnLabInitializer : CreateDatabaseIfNotExists<XamarinHandsOnLabContext>
    {
        protected override void Seed(XamarinHandsOnLabContext context)
        {
